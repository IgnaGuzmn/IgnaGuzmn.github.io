...
taboaContidos[0]=new act("Ordenar imágenes","Ordenar imágenes","","<object width='100%' height='420' type='text/html' data='OrdenBiolo/OrdenBiolo.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Puzzle","Puzzle","","<object width='100%' height='420' type='text/html' data='Puzle_GG/Puzle_GG.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("Ordenar frases","Ordenar frases","","<object width='100%' height='420' type='text/html' data='ftfrasess/ftfrasess.htm'></object>",false,"",true,true,true);
taboaContidos[3]=new act("Sopa de letras","Sopa de letras","","<object width='100%' height='420' type='text/html' data='BIO/BIO.htm'></object>",false,"",true,true,true);
