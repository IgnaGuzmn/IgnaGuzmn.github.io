...
$("#ardoraQuest").html("<img id='playSound' class='imaLeft' src='juego_feria_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
...
contexto.fillRect(0, 0, canvas.width, canvas.height);contexto.font = "19px " + fMenssage;
var metricsW = contexto.measureText(textBNext).width;var x = canvas.width - metricsW -50 ;var y = canvas.height-19-40;
...
roundedRect(contexto, x, y, metricsW+45,19+20, 5, colorButton);contexto.shadowColor = "black";contexto.shadowBlur = 15;
...
contexto.fillText(textBNext,x+10,y+19+10);contexto.lineWidth=5;contexto.stroke();contexto.fill();
