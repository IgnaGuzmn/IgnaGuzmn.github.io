...
taboaContidos[0]=new act("Ordenar frases","Ordenar frases","","<object width='100%' height='420' type='text/html' data='Frases/Frases.htm'></object>",false,"",true,false,true);
taboaContidos[1]=new act("Ordenar párrafos","Ordenar párrafos","","<object width='100%' height='420' type='text/html' data='Parrafos/Parrafos.htm'></object>",false,"",true,false,true);
taboaContidos[2]=new act("Colorear según leyenda","Colorear según leyenda","","<object width='100%' height='420' type='text/html' data='Coloerar/Coloerar.htm'></object>",false,"",true,false,true);
