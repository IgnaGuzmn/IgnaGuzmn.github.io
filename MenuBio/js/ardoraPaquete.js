...
taboaContidos[0]=new act("Ordenar imágenes","Ordenar imágenes","","<object width='100%' height='420' type='text/html' data='OrdenBiolo/OrdenBiolo.htm'></object>",false,"Ordena las imágenes en el orden correspondiente",true,true,true);
taboaContidos[1]=new act("Puzzle","Puzzle","","<object width='100%' height='420' type='text/html' data='Puzle_GG/Puzle_GG.htm'></object>",false,"Arma el puzzle",true,true,true);
taboaContidos[2]=new act("Ordenar frases","Ordenar frases","","<object width='100%' height='420' type='text/html' data='ftfrasess/ftfrasess.htm'></object>",false,"Ordena las frases correctamente",true,true,true);
taboaContidos[3]=new act("Sopa de letras","Sopa de letras","","<object width='100%' height='420' type='text/html' data='BIO/BIO.htm'></object>",false,"Encuentra las palabras en la sopa de letras",true,true,true);
taboaContidos[4]=new act("Ahorcado","Ahorcado","","<object width='100%' height='420' type='text/html' data='juego_feria/juego_feria.htm'></object>",false,"Adivina que palabra es",true,true,true);
taboaContidos[5]=new act("Crucigrama","Crucigrama","","<object width='100%' height='420' type='text/html' data='xd/xd.htm'></object>",false,"Completa el crucigrama",true,true,true);
